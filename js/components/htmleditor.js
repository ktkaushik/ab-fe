...
(function(addon) {
    ...
    UI.component('htmleditor', {
        ...
        defaults: {
            ...
            toolbar      : [ 'div', 'para', 'bold', 'italic', 'strike', 'link', 'image', 'table', 'blockquote', 'listUl', 'listOl', 'lalign', 'calign', 'ralign', 'justify', 'superscript', 'subscript', 'code' ],
            lblPreview   : 'Preview',
            lblCodeview  : 'HTML',
    ...
    UI.plugin('htmleditor', 'base', {
        ...
        init: function(editor) {
            ...
            editor.addButtons({
                ...
                div : {
                    title  : 'Div',
                    label  : '<strong>DIV</strong>'
                },
                para : {
                    title  : 'Paragraph',
                    label  : '<i class="uk-icon-paragraph"></i>'
                },
                bold : {
                    title  : 'Bold',
                ...
                lalign : {
                    title  : 'Left Align',
                    label  : '<i class="uk-icon-align-left"></i>'
                },
                calign : {
                    title  : 'Center Align',
                    label  : '<i class="uk-icon-align-center"></i>'
                },
                ralign : {
                    title  : 'Right Align',
                    label  : '<i class="uk-icon-align-right"></i>'
                },
                justify : {
                    title  : 'Justify',
                    label  : '<i class="uk-icon-align-justify"></i>'
                },
                superscript : {
                    title  : 'Super Script',
                    label  : '<i class="uk-icon-superscript"></i>'
                },
                subscript : {
                    title  : 'Sub Script',
                    label  : '<i class="uk-icon-subscript"></i>'
                },
                code : {
                    title  : 'Code',
            ...
            addAction('div', '<div>$1</div>');
            addAction('para', '<p style="font-family: Lato; font-weight: 300;  color: #666666; text-align: justify">$1</p>');
            addAction('bold', '<strong>$1</strong>');
            addAction('italic', '<em>$1</em>');
            addAction('strike', '<del>$1</del>');
            addAction('blockquote', '<blockquote style="border-left: 5px solid #dddddd; padding: 10px; font-family: "Times New Roman"; font-size: 24px; color: #555555;"><p>$1</p></blockquote>', 'replaceLine');
            addAction('link', '<a href="http://">$1</a>');
            addAction('image', '<img src="http://" alt="$1">');
            addAction('table', '<table class="uk-table">\n\
    ...
    <tbody>\n\
        <tr>\n\
            ...
            addAction('lalign', '<p style="text-align: left;">$1</p>');
            addAction('calign', '<p style="text-align: center;">$1</p>');
            addAction('ralign', '<p style="text-align: right;">$1</p>');
            addAction('justify', '<p style="text-align: justify;">$1</p>');            
            addAction('superscript', '<sup>$1</sup>');
            addAction('subscript', '<sub>$1</sub>');            
            addAction('code', '<pre class="uk-scrollable-text"><code class="php">$1</code></pre>');            
